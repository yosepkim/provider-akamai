...
PROJECT_REPO ?= github.com/yosepkim/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/yosepkim/terraform-provider-akamai
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-akamai_6.2.0
